...
class Category
{
	...
	/*获取指定数量的分类*/
    function GetCategoryByNum($type='article',$skip=0,$take=10,$orderby="displayorder")
    {
        global $yiqi_db;
        $sql = "select * from yiqi_category where type = '$type' order by $orderby limit $skip,$take";
