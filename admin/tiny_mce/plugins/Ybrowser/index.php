...
var browser = new SwampyBrowser("<?php echo $HOST;?>","<?php echo $dir;?>", "");
...
<?php echo $JAVA_DLG;?>
	...
	<body onLoad="browser.init();">
		<div id="alert" style="display:none;"><p class='error'>{#Ibrowser_dlg.ok}</p></div>
