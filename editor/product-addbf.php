...
if($action=='save')
{
	...
	}else if (isset($_POST['productbigimg']))
	{
		$productthumb = $_POST['productbigimg'];
	}
	...
	$sql = "INSERT INTO yiqi_product (pid ,name ,cid ,thumb,bigimg,seotitle ,seokeywords ,seodescription,content ,para,adddate ,lasteditdate,filename ,templets,status)" .
		   "VALUES (NULL, '$productname', '$productcategory', '$productthumb','$productbigimg','$productseotitle', '$productkeywords', '$productdescription', '$productcontent','$productpara', '$productadddate', '$nowdate','$productfilename', '$producttemplets', 'ok')";
...
<tr>
	...
	<td class="input">
		<div id="bptinfo">
			<input class="upfile txt" type="file" style="width:280px;" name="productbigimg" /> 或者 <a href="javascript:void(0);" onclick="setinput();" style="color:#0000cc;">输入地址</a>
		</div>
	</td>
</tr>
<!--end-->
...
<tr>
	...
	<td class="input">
        <textarea id="paraform" rows="1" cols="1" style="width:580px;height:360px;" name="productpara"></textarea>
    </td>
</tr>
<!-- Load TinyMCE -->
