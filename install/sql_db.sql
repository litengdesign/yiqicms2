...
CREATE TABLE `yiqi_article` (
  ...
  `status` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
    `newsthumb` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `istop` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'false',
  PRIMARY KEY (`aid`)
...
CREATE TABLE `yiqi_product` (
  ...
  `thumb` text COLLATE utf8_unicode_ci DEFAULT NULL,
   `bigimg` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `seotitle` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '-',
  `seokeywords` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `seodescription` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `filename` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '-',
  ...
  `viewcount` bigint NOT NULL DEFAULT '0',
  `status` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `isgood` varchar(20) COLLATE utf8_unicode_ci NULL DEFAULT 'false',
  `isnew` varchar(20) COLLATE utf8_unicode_ci NULL DEFAULT 'false',
  PRIMARY KEY (`pid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
#<--break-->
...
#<--break-->
INSERT INTO `yiqi_article` (`aid`, `title`, `cid`, `uid`, `seotitle`, `seokeywords`, `seodescription`, `filename`, `content`, `adddate`, `lasteditdate`, `templets`, `viewcount`, `status`) VALUES
(1, '公司介绍', 1, 1, '公司介绍', '公司介绍', '公司介绍', 'about', '<p><a href="http://www.linpin.com">上海林频仪器股份有限公司</a>座落于中国上海市科技产业基地闵行经济技术开发区，是一家专业从事环境试验设备研发、生产与销售于一体的高新技术股份制企业。历经市场洗礼和多年的拼搏积淀，林频仪器现已发展成为环境试验设备领域的龙头企业之一。</p>', now(), now(), 'article.tpl', 1, 'ok'),
(3, '又一个林频的网站开通了', 2, 1, '又一个林频的网站开通了', '又一个林频的网站开通了', '又一个林频的网站开通了', 'yiqi-starter', '<p>又一个使用<a href="http://www.linpin.com">林频股份</a>的网站开通了.</p>', now(), now(), 'article.tpl', 1, 'ok'),
...
(1, '林频官网', 'http://www.linpin.com/', 0, now(), '林频官网', 'ok'),
(2, '林频论坛', 'http://www.linpin.com/bbs/', 0, now(), '林频官方论坛', 'ok');
#<--break-->
...
(1, 'sitename', '网站名称', '林频仪器股份'),
(3, 'sitetemplets', '网站模板', '1'),
(4, 'siteicp', '网站备案号码', '-'),
(5, 'sitestat', '网站统计代码', '-'),
(6, 'sitecopy', '网站版权信息', '© 2009-2010 <a href="http://www.linpin.com">林频股份</a>'),
(7, 'titlekeywords', '网站标题关键词', '林频仪器股份'),
(8, 'metakeywords', 'META关键词', '恒温恒湿试验箱,恒温恒湿箱,恒温恒湿试验机,试验箱,恒温恒湿机,可程式恒温恒湿箱'),
(9, 'metadescription', 'META描述', '【林频股份】专业研发生产恒温恒湿试验箱、恒温恒湿试验机、恒温恒湿箱、可程式恒温恒湿箱、高低温试验箱、盐雾试验箱等全套环境试验设备,凭借坐拥中国环试行业最大的生产制造基地、具有最齐全的产品与企业资质证书、享有极高的市场信誉度与客户忠诚度成就行业领导品牌，取代进口品牌成为业界标杆！免费服务热线：4000-662-888'),
(10, 'urlrewrite', '是否开始URL重写', 'false'),
(11, 'companysummary', '公司简介', '<p>上海林频仪器股份有限公司座落于中国上海市科技产业基地闵行经济技术开发区，是一家专业从事环境试验设备研发、生产与销售于一体的高新技术股份制企业。历经市场洗礼和多年的拼搏积淀，林频仪器现已发展成为环境试验设备领域的龙头企业之一。</p>'),
(12, 'companyname', '公司名称', '林频仪器股份'),
...
(22, 'siteauthor', 'meta作者', '林频仪器股份'),
(23, 'copyright', 'meta版权', '本页版权归 上海林频仪器股份有限公司 所有. All Rights Reserved'),
(24, 'searchtitle', 'meta搜索标题', 'Temperature and humidity chamber  恒温恒湿试验箱');
#<--break-->
INSERT INTO `yiqi_templets` (`tid`, `name`, `directory`, `thumb`, `author`, `copyright`, `adddate`, `status`) VALUES
(1, '默认模板', 'default', '../templets/default/preview.gif', 'YIQICMS', 'Copyright 2009 linpin.com all rights reserved.', now(), 'ok'),
(2, '红粉之家', 'redpink', '../templets/redpink/preview.gif', 'YIQICMS', 'Copyright 2009 linpin.com all rights reserved.', now(), 'ok');